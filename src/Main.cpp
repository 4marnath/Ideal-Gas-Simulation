...
//Number of particles in the square
int pinbox = 0;
...
//Expected value of average velocity
float Vavg_th = sqrt(8 * k2 * Temp / (3.1416 * mass2));

bool initialpos = true, initialvel = true, gravityOn = true;

//Storing n particles in a vector b
std::vector <gas> b(n);
...
//To draw the outline of the square in the selected region
...
//To check whether a particle is inside the square
...
int main()
{   
    //Disabling console window during execution:
    #pragma comment(linker, "/SUBSYSTEM:windows /ENTRY:mainCRTStartup")

    //Dividing the viewpost into 4 squares or sections
    ...
    //Number of particles and pressure in each section
    int ntl, ntr, nbl, nbr;
    ...
    //Whether cursor is in the viewport
    bool mouseIn = true;
    ...
    //Style settings for different components in the UI
    ...
    {   
        ...
        //Calculate expected and actual pressure in selected section
        ...
        //Check where the left mouse button is clicked and set the values to mx and my
        ...
        //Select the corresponding section from the mouse click
        ...
        //Right click to deselect section and act like the cursor is not in the viewport
        ...
        //Colour of particle is given by the input
        ...
        //Set particle velocity depending on the input temperature
        if (initialvel)
        {
            for (gas& i : b)
            {
        ...
        //Display all the expected and actual values
